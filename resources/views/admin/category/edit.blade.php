...
@section('content')
                ...
                <div class="col-md-12">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="page-title py-3">
                            <h4 class="fw-bold mb-2">Edit Category</h4>
                            <nav>
    ...
    <!-- Basic with Icons -->
    <div class="col-xxl">
        <form method="POST" action="{{ url('admin/category/list/' . $category->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 d-flex">
                                    ...
                                    <textarea type="text" class="form-control" id="premiumskinsandicons-small" name="description"
                                        placeholder="Description" width="100%" height="300px">{{ $category->description }}</textarea>
                                    @error('description')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-2">
                                    <div class="img-prev-div">
                                        <img src="{{ asset('/uploads/category/' . $category->image) }}" id="img-prev" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 d-flex">
                                    ...
                                    <select id="parentCategory" name="parentCategory" class="form-select">
                                        <option hidden selected>{{ $category->parentCategory }}</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 d-flex">
                                    ...
                                    <input type="text" class="form-control" id="metaTitle" name="metaTitle"
                                        value="{{ $category->metaTitle }}" placeholder="Meta Title" />
                                    @error('metaTitle')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 d-flex">
                                    ...
                                    <input type="text" class="form-control" id="metaKeywords" name="metaKeywords"
                                        value="{{ $category->metaKeywords }}" placeholder="Meta Keywords" />
                                    @error('metaKeywords')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
